  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterLlearnApp.author.home.createOrEditLabel" data-cy="AuthorCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Birth Date" id="author-birthDate" name="birthDate" data-cy="birthDate" type="date" />
